...
(lem/themes::define-color-theme "black" nil
  ...
  (syntax-string-attribute :foreground "#ffbf00")
  (syntax-builtin-attribute :foreground "#00ff95")
  (syntax-comment-attribute :foreground "#ff3333")
  ...
  (lem/isearch:isearch-highlight-attribute :background "#00aaff")
  (lem/isearch:isearch-highlight-active-attribute :background "#006ea6")
...
(setf lem/line-numbers:*relative-line* t
      *auto-format* t
      ...
      (variable-value 'lem-core::highlight-line-color) "#202020"
      (variable-value 'lem/line-numbers:line-number-format) "~2d "
      (variable-value 'lem/line-numbers:custom-current-line) "->")
